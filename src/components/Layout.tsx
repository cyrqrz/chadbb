  ...
  return <div className="mx-auto flex min-h-screen max-w-6xl flex-col px-6 md:px-12">
    ...
    <header className="site-header border-b border-stone-300">
      <div className="flex flex-wrap items-center justify-between gap-x-4 gap-y-2 py-4">
        <Link to="/" aria-label="chadbb, início" className="brand inline-flex min-h-11 items-center gap-2.5 text-xl font-extrabold tracking-tight"><span className="brand-mark" aria-hidden="true">c</span>chadbb<span className="-ml-2.5 text-[var(--brand)]" aria-hidden="true">.</span></Link>

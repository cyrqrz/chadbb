...
insert into public.events (id,owner_id,title,starts_at,ends_at) values
 ('10000000-0000-4000-8000-000000000001','00000000-0000-4000-8000-000000000001','Evento A', now() + interval '1 day', now() + interval '2 days'),
 ('10000000-0000-4000-8000-000000000002','00000000-0000-4000-8000-000000000002','Evento B', null, null);
...
select throws_ok($$ select public.save_event('10000000-0000-4000-8000-000000000002',1,'ataque','',now(),now()+interval '1 hour','','',null) $$,'42501','EVENT_NOT_FOUND','não edita evento alheio');
...
select throws_ok($$ select public.save_event('10000000-0000-4000-8000-000000000001',3,'alterado','',now(),now()+interval '1 hour','','',null) $$,'P0001','EVENT_CLOSED','evento encerrado não aceita edição');
